...
Class Xhr extends Public_Controller {
    ...
    public function service_map() {
        ...
        //$locations = $this->DealerNetworks->execute_query("SELECT * FROM tbl_provinces WHERE ".implode(' OR ', $searchTermBits)." LIMIT 0, 1;");
        //if($locations->row_data == 0) {
            //$locations = $this->DealerNetworks->execute_query("SELECT * FROM tbl_provinces WHERE ".implode(' OR ', $searchTermBits)." LIMIT 0, 1;");
        //}
